...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        search_for_ssl_incs_in = [
			      '/home/zhilongf/poponfs/install/include',
        ...
        ssl_libs = find_library_file(self.compiler, 'ssl',lib_dirs,
                                     [
				      '/home/zhilongf/poponfs/install/lib',
				      '/usr/local/ssl/lib',
                                      '/usr/contrib/ssl/lib/'
                                     ] )
...
##         self.extensions.append(ext)
	...
	print "############################################################################################################>>>"
        ...
        include_dirs = ['Modules/_ctypes/', 'Modules/_ctypes/libffi/', 'Modules/_ctypes/libffi/include']
        extra_compile_args = ['-IModules/_ctypes/libffi/include']
        extra_link_args = []
