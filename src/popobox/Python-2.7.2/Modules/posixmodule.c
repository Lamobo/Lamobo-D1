...
static PyObject*
_pystatfs_fromstructstatfs(struct statfs st) {
    PyObject *v = PyStructSequence_New(&StatVFSResultType);
    if (v == NULL)
        return NULL;
    ...
    PyStructSequence_SET_ITEM(v, 5, PyInt_FromLong((long) st.f_files));
    PyStructSequence_SET_ITEM(v, 6, PyInt_FromLong((long) st.f_ffree));
    PyStructSequence_SET_ITEM(v, 7, PyInt_FromLong((long) 0));
    PyStructSequence_SET_ITEM(v, 8, PyInt_FromLong((long) 0));
    PyStructSequence_SET_ITEM(v, 9, PyInt_FromLong((long) 0));
#else
    PyStructSequence_SET_ITEM(v, 0, PyInt_FromLong((long) st.f_bsize));
    PyStructSequence_SET_ITEM(v, 1, PyInt_FromLong((long) st.f_frsize));
    PyStructSequence_SET_ITEM(v, 2,
    ...
    PyStructSequence_SET_ITEM(v, 6,
                              PyLong_FromLongLong((PY_LONG_LONG) st.f_ffree));
    PyStructSequence_SET_ITEM(v, 7,
                              PyLong_FromLongLong((PY_LONG_LONG) 0));
    PyStructSequence_SET_ITEM(v, 8, PyInt_FromLong((long) 0));
    PyStructSequence_SET_ITEM(v, 9, PyInt_FromLong((long) 0));
#endif
...
posix_statvfs(PyObject *self, PyObject *args)
{
    ...
    return _pystatfs_fromstructstatfs(st);
}
#endif /* HAVE_STATVFS */
