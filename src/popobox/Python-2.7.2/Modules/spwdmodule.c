...
struct spwd {
  ...
  int sp_warn;                  /* number of days of warning before password expires */
  int sp_inact;                 /* number of days after password expires until the account becomes unusable. */
  int sp_expire;                /* days since 1/1/70 until account expires */
