...
enum isp_working_mode {
	...
	ISP_JPEG_VIDEO,
	ISP_YUV_VIDEO_OUT,
	ISP_YUV_VIDEO_EMERGEOUT,
	ISP_YUV_VIDEO_BYPASS,
	ISP_RGB_SINGLE,
	ISP_RGB_VIDEO,
	ISP_RGB_SINGLE_BIG,
};
...
#define  ISP_CID_SPECIAL_EFFECT		0x73		//special effect
...
struct isp_brightness_enhance {
	...
	int	uv_filter_enable;	//register table 0x24: offset register 13 [30]
